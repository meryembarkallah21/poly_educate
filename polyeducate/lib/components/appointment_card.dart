...
class AppointmentCard extends StatefulWidget {
  AppointmentCard({Key? key, required this.professor, required this.color})
      : super(key: key);
        ...
        child: Padding(
          ...
          child: Column(
            children: <Widget>[
              ...
              Row(
                children: [
                  ...
                  Column(
                    ...
                    children: <Widget>[
                      Text(
                        'Mr/Mrs ${widget.professor['professor_name']}',
              ...
              //Schedule info here
              ScheduleCard(
                appointment: widget.professor['appointments'],
              ),
              Config.spaceSmall,
              //action button
              Row(
                        ...
                        showDialog(
                            ...
                            builder: (context) {
                              return RatingDialog(
                                  ...
                                  message: const Text(
                                    'Please help us to rate our Professor',
                                    textAlign: TextAlign.center,
                                    style: TextStyle(
                                      fontSize: 15,
                                    ),
                                  ...
                                  onSubmitted: (response) async {
                                    ...
                                    final rating = await DioProvider()
                                        ...
                                        response.comment,
                                        response.rating,
                                        widget.professor['appointments']
                                        ['id'], //this is appointment id
                                        widget.professor[
                                        'prof_id'], //this is professor id
                                        token);
